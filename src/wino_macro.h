...
#if LOG2CEIL(2+WINO_OUT_SIZE*WINO_WIDTH) < 3
#define INBUFFER_WIDTH_BITWIDTH 3
#else
#define INBUFFER_WIDTH_BITWIDTH LOG2CEIL(2+WINO_OUT_SIZE*WINO_WIDTH)
#endif
...
#elif WINO_HEIGHT ==1
#define WEIGHT_FEED_NUMBER_PER_PORT 1
#define WEIGHT_FEED_NUMBER_PER_PORT_BITWIDTH 0
#else 
