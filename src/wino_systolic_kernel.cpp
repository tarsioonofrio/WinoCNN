...
void wino_systolic_kernel(    WEIGHT_PORTS_DECLARE(weight_DDR),
	...
	ap_uint<OUT_WIDTH*BATCH_SIZE> out_buffer0_0_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*BATCH_SIZE> out_buffer1_0_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*BATCH_SIZE> out_buffer2_0_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*BATCH_SIZE> out_buffer3_0_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
