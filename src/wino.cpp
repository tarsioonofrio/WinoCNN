    ...
    )
{
    ...
    #pragma HLS array_partition variable=input_buffer complete dim=2 
    #pragma HLS resource variable=input_buffer core=RAM_S2P_BRAM 
    ap_uint<OUT_WIDTH*BATCH_SIZE> output_buffer0[WINO_OUT_SIZE_CELL][OUTDEPTH_MINITILE_SIZE/WINO_H2][WINO_WIDTH/WINO_W2][WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH];
    ...
    ap_uint<OUT_WIDTH*BATCH_SIZE> output_buffer1[WINO_OUT_SIZE_CELL][OUTDEPTH_MINITILE_SIZE/WINO_H2][WINO_WIDTH/WINO_W2][WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH];
